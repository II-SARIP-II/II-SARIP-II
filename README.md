...
<img src="https://terminal-identity-opal.vercel.app/api?name=Pâris&username=II-SARIP-II&role=Computer+Science+Engineer&tagline=Making+heavy+code+run+light.+Because+life+is+too+short+for+slow+algorithms.&status=available+for+cool+internet+projects&command=contact+me&theme=amber%2Fcobalt&avatar=SP&pattern=grid&width=900&height=auto&showLangs=on&showContribs=on&langCount=5&excludeLangs=java%2Ccss%2Cc%2B%2B%2Chtml&langStyle=icons&iconSize=lg&motion=scan&contribTheme=constellation&contribMode=focus&bio=STUDIES%3A%0A%0A•+42+Student%0A•+Bachelor’s+Degree+in+Web+Development%0A‎+%0A‎+%0ASKILLS%3A%0A•+AI+-+RAG%2C+Constrained+Decoding%0A•+Algorithms+-+Maze%2C+Multi-agent+graph%2C+Sorting+algorithms+%28Radix%2C+chunk-based...%29%0A•+Multithreading+-+%28mutex%2C+cond%2C+threads%29‎%0A•+Web+Development+-+FullStack+%28Vue%2C+React%2C+Next%2C+Laravel%29%0A‎+%0A‎+%0AINTERSHIP%3A%0A•+BP-Web+—+Full-Stack+Web+Developer%0A•+TELT+%28Lyon-Turin+Tunnel%29+—+Data+Science+Developer" width="100%" alt="Terminal identity card" />
