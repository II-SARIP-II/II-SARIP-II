...
<img src="https://terminal-identity-opal.vercel.app/api?name=Pâris&username=II-SARIP-II&role=Computer+Science+Engineer&tagline=Making+heavy+code+run+light.+Because+life+is+too+short+for+slow+algorithms.&status=available+for+cool+internet+projects&command=contact+me&theme=amber%2Fcobalt&avatar=SP&pattern=grid&width=900&height=auto&showLangs=on&showContribs=on&langCount=5&excludeLangs=java%2Ccss%2Cc%2B%2B%2Chtml&langStyle=icons&iconSize=lg&motion=scan&contribTheme=constellation&contribMode=focus&bio=•+42+Student%0A•+Bachelor’s+Degree+in+Web+Development%0A‎+%0AAI%3A%0A-+Constrained+decoding%0A-+RAG%0A‎+%0AAlgorithms%3A%0A-+Maze+generation+%26+resolution%0A-+Multi-agent+graph+pathfinding%0A-+Sorting+algorithms+%28Radix%2C+chunk-based...%29%0A‎+%0AMultithreading%3A%0A-+Shared+State+Isolation%0A-+Immutability%0A-+Synchronization+%2F+Locking%0A-+Atomic+Operations%0A‎+%0AWeb+Development%3A%0A-+JS%2FTS+%28Vue%2C+React%2C+Next%29%0A-+PHP+%28Laravel%2C+Symfony%29%0A-+HTML+%2F+C" width="100%" alt="Terminal identity card" />
<p align="center">
